...
if os.environ.get("GCP_LOG_USE_X_HTTP_CLOUD_CONTEXT"):
    USE_X_HTTP_CLOUD_CONTEXT = os.environ.get("GCP_LOG_USE_X_HTTP_CLOUD_CONTEXT") or False
    TRANSPORT_PARENT = None
else:
    ...
    def init_app(self, app):
        ...
        def add_logger(response):
            ...
            REQUEST = {
                ...
                'remoteIp': (request.headers.get(REMOTE_IP_HEADER) if REMOTE_IP_HEADER else None) or request.remote_addr,
